...
graph TD
    ...
    ApplicationTracker((Application Tracker - add/delete/view))
    LetterToEmployer[Letter to Employer]
    ...
    %% Connections - Additional Features
    Home --> LetterToEmployer
    Home --> SavedJobs
    SavedJobs -- Saved Jobs Data --> JobDB
    ...
    class Home,ResumeUpload,JobList,LetterToEmployer,SavedJobs process;
